### Вступительное задание на стажировку Javarush

> Spring MVC, Hibernate, JSP, Maven, MySQL
...
__Бизнес-требование:__ ниже списка деталей всегда выводить поле, в котором выводится, сколько компьютеров можно собрать из деталей в наличии. Для сборки одного компьютера должны быть в наличии все детали, которые отмечены как необходимые.
